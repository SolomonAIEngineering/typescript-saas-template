...
#### 👉 Self-hosting the OSS version ([MIT License](/github.com/SolomonAIEngineering/typescript-saas-template?tab=MIT-1-ov-file#readme))

To run the AI gateway locally, execute the following command in your terminal. (Needs npx installed) Or, explore deployment guides for [Cloudflare](/github.com/SolomonAIEngineering/typescript-saas-template/blob/main/docs/installation-deployments.md#cloudflare-workers), [Docker](/github.com/SolomonAIEngineering/typescript-saas-template/blob/main/docs/installation-deployments.md#docker), [Node.js](/github.com/SolomonAIEngineering/typescript-saas-template/blob/main/docs/installation-deployments.md#nodejs-server) and more [here](#deploying-the-ai-gateway).
```bash
...
### [More Examples](/github.com/SolomonAIEngineering/typescript-saas-template/tree/main/cookbook)
...
Bug Report? [File here](/github.com/SolomonAIEngineering/typescript-saas-template/issues) | Feature Request? [File here](/github.com/SolomonAIEngineering/typescript-saas-template/issues)
...
![Rubeus Social Share (4)](/github.com/SolomonAIEngineering/typescript-saas-template/assets/971978/89d6f0af-a95d-4402-b451-14764c40d03f)
